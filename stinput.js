...
class StInput
{
    ...
    constructor()
    {
        ...
        var _this = this;
        this._callbacks = {
            'mousedown': function(event) {_this._onMouseDown(event); event.preventDefault(); },
            'mouseup': function(event) {_this._onMouseUp(event); event.preventDefault(); },
            'mousemove': function(event) {_this._onMouseMove(event); event.preventDefault(); },
            'keydown': function(event) {_this._onKeyDown(event); event.preventDefault(); },
            'keyup': function(event) {_this._onKeyUp(event); event.preventDefault(); },
            'blur': function(event) {_this._onBlur(event); event.preventDefault(); },
            'wheel': function(event) {_this._onMouseWheel(event); },
            'touchstart': function(event) {_this._onMouseDown(event); event.preventDefault(); },
            'touchend': function(event) {_this._onMouseUp(event); event.preventDefault(); },
            'touchmove': function(event) {_this._onMouseMove(event); event.preventDefault(); },
        };
        ...
        for (var event in this._callbacks) {
            window.addEventListener(event, this._callbacks[event], false);
        }
    }
